...
export default function Concept03SplitFiles() {
  ...
  return (
    <div>
      ...
      <p className="guide">
<<<<<<< HEAD:React자료/실습프로젝트/src/08_Vite로_옮기기/개념04_컴포넌트_파일로_나누기.jsx
...
=======
        ...
        보세요.
>>>>>>> 19abc81041adffce487d49a2e25ba12fd243f4d7:04_React/실습프로젝트/src/08_파일_나누기와_스타일링/개념03_컴포넌트_파일로_나누기.jsx
        <br />
        <br />세 파일 모두{" "}
