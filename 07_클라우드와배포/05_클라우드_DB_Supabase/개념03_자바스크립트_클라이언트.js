...
// ============================================================
//
<<<<<<< HEAD:07_클라우드와배포/05_클라우드_DB_Supabase/개념03_자바스크립트_클라이언트.js
...
async function 요청보기() {
  ...
  // select * from equipments where from A;
  ...
  await 기록용.from("equipments").select("*").or("line.eq.A,line.eq.B"); // 라인이 A 이거나 B 인거 //
  await 기록용
    .from("equipments")
    .select("*")
...
//
>>>>>>> 9867716458f8aa7c7d01a07d2cc319607de22c97:08_클라우드와배포/05_클라우드_DB_Supabase/개념03_자바스크립트_클라이언트.js
// ★★ 규칙이 보이시죠.
//
//     칸 = 연산 . 값
//
