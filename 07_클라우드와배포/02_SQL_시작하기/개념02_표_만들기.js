...
const db = new DatabaseSync("./data/02개념.db");
...
//     내용 TEXT                   ← 마지막 칸 뒤에는 쉼표를 안 찍습니다 // A,B 이면 2개 (,1개)
...
db.exec("CREATE TABLE IF NOT EXISTS 헐렁 (수량 INTEGR)"); // ← INTEGER 를 INTEGR 로 잘못 씀
