...
const 전부 = db.prepare("SELECT * FROM 설비").all(); // * = 전체를 보겠다 //
...
// 이름순 [{"name":"용접로봇 1호"},{"name":"컨베이어 1호"},{"name":"프레스 1호"}]
...
// 출력: 통과 → "123.0" (text) // 이름은 text가 들어간다 //
...
것넣기.run("넷째"); // 3 -> 그 위에 내용이 지워졌으니 넣으면 다시 3 //
