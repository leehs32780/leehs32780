...
const filePath1 = "회의록_2026.docx";

console.log(path.extname(filePath1));
console.log(path.basename(filePath1, ".docx"));
...
const name1 = "검사성적서.xlsx";

const a = path.extname(name1); // 확장자 : a에 저장 //
const b = path.basename(name1, a); // 검사성적서 : b에 저장 //
...
// 그래서 실무에서는 항상 __dirname 을 기준으로 씁니다. // 언더바 2개 //
//
