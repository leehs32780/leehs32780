...
// Create (만들기) : post , Read (읽기) : get , Update (고치기) : put, patch , Delete (지우기) : Delete //
...
// 직접 해보기 1: 설비 번호가 들어간 주소에서 경로 파라미터 확인하기
app.get("/equipments/:id/logs", (req, res) => {
  res.json(req.params);
});

// 확인: GET /equipments/7/logs
// 응답: 200 {"id":"7"}
...
//                    (확인했으면 반드시 되돌리세요)
// Missing parameter name at index 8: /files/* // *에 이름을 붙여야 한다 //
