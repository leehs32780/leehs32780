...
// 출력: https:
// 콜론이 함께 나옵니다. "https" 가 아니라 "https:" 입니다. // 약속 //
...
console.log(주소.port);
// 출력: 8080
// 그 컴퓨터의 몇 번 문으로 들어갈지입니다. 섹션 3에서 자세히 봅니다. // 숫자 //

console.log(주소.pathname);
// 출력: /documents/12
// ★ 서버에서 가장 중요한 부분입니다. "무엇을 달라는가" 가 여기 담깁니다. // 어디로 간다 //
...
const 주소1 = new URL("http://localhost:3000/api/users");
console.log(주소1.hostname);
console.log(주소1.port);
console.log(주소1.pathname);

// ── 섹션 2: 쿼리 스트링 — 조건을 함께 보내기 ──

// 경로 뒤 ? 부터가 쿼리입니다. "어떤 조건으로" 를 담습니다.
//
//     /documents?type=pdf&page=2 // 다 string - URL에 있는거 //
//               ─────────────────
...
const 주소3 = new URL("http://localhost:3000/search?q=작업표준서&limit=10");
console.log(주소3.searchParams.get("q"));
console.log(주소3.searchParams.get("limit"));
console.log(typeof 주소3.searchParams.get("limit"));

// ── 섹션 3: localhost 와 포트 ──

// 서버를 만들면 이런 주소로 접속하게 됩니다.
//
//     http://localhost:3000 // localhost 3000번으로 이동한다는 의미 //
//
// [localhost]
...
const site = new URL("http://localhost:4000/api/documents");
...
const peace = new URL("http://localhost:3000/api/lines/A/machines/3");
console.log(peace.pathname.split("/").filter((a) => a !== ""));
