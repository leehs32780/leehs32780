...
const sum4 = number1.reduce((acc, n) => acc + n);
console.log(sum4); // 매개변수 : 1개 // reduce((acc, n) => acc + n, 0); - 이건 매개변수 : 2개
...
const max = scores.reduce((acc, n) => (n > acc ? n : acc), scores[0]); // 그냥 0 쓰기 X //
console.log(max);
// 출력: 90
